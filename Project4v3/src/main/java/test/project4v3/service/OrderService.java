...
import test.project4v3.dto.OrderItemDTO;
...
import test.project4v3.repository.OrderRepository;
...
public class OrderService {
    ...
    public List<OrderDTO> getUserOrders(User userId) {
        List<OrderEntity> orders = (List<OrderEntity>) orderRepository.findByUserId(userId);
    ...
    public List<OrderEntity> getOrdersByUserId(User userId) {
        return (List<OrderEntity>) orderRepository.findByUserId(userId);
    }
